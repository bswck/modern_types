...
https://github.com/bswck/skeleton/tree/019d36a/fragments/contributing.md
-->
# Contributing to [modern_types](https://github.com/bswck/modern_types) 🎉
Contributions are very welcome. 🚀

There are many ways to contribute, ranging from **writing tutorials and improving the documentation**, to **submitting bug reports and feature requests** or **writing code** which can be incorporated into modern_types.

## Report bugs and request features 🐛
Report these in the [issue tracker](https://github.com/bswck/modern_types/issues).
Relevant forms provide guidance on how to write a good bug report or feature request.

## Implement new features ⭐
[Look here](https://github.com/bswck/modern_types/issues?q=is%3Aopen+label%3Aenhancement+sort%3Aupdated-desc).
...
1. Ensure that the [test coverage](https://coverage-badge.samuelcolvin.workers.dev/redirect/bswck/modern_types) is not decreased. If you add a new feature, please add tests for it. [Read more about coverage](https://coverage.readthedocs.io/en/latest/index.html).
...
Ready to contribute? Here's a quick guide on how to set up modern_types and make a change.


<!--
This section was generated from bswck/skeleton@019d36a.
Instead of changing this particular file, you might want to alter the template:
https://github.com/bswck/skeleton/tree/019d36a/fragments/guide.md
-->
