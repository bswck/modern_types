...
patch("typing.Generator", (_YieldT_co, _SendT_contra, _ReturnT_co), noop_ok=True)
...
patch("typing.Coroutine", (_YieldT_co, _SendT_contra, _ReturnT_co), noop_ok=True)
...
patch("typing.AsyncGenerator", (_YieldT_co, _SendT_contra), noop_ok=True)
...
patch("multiprocessing.sharedctypes.Synchronized", (_T,), noop_ok=True)
...
patch("redis.asyncio.cluster.RedisCluster", (_StrType,), noop_ok=True)
...
patch("openpyxl.worksheet.dimensions.DimensionHolder", (_DimT,), noop_ok=True)

# Generated from `class ArrayDescriptor(Generic[_T]):`
# @ typeshed/stubs/openpyxl/openpyxl/styles/cell_style.pyi:15
patch("openpyxl.styles.cell_style.ArrayDescriptor", (_T,), noop_ok=True)
...
patch("flake8_plugin_utils.plugin.Visitor", (TConfig,), noop_ok=True)

# Generated from `class Plugin(Generic[TConfig]):`
# @ typeshed/stubs/flake8-plugin-utils/flake8_plugin_utils/plugin.pyi:29
patch("flake8_plugin_utils.plugin.Plugin", (TConfig,), noop_ok=True)
