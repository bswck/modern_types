"""
Automatically register generic classes from typeshed.

Generated by modern_types/scripts/generate_registrators.py 🛸
"""
...
from __modern_types__ import register
...
def register_stdlib_generics() -> None:
    ...
    register("typing.Generator", (_YieldT_co, _SendT_contra, _ReturnT_co), noop_ok=True)
    ...
    register("typing.Coroutine", (_YieldT_co, _SendT_contra, _ReturnT_co), noop_ok=True)
    ...
    register("typing.AsyncGenerator", (_YieldT_co, _SendT_contra), noop_ok=True)
    ...
    register("multiprocessing.sharedctypes.Synchronized", (_T,), noop_ok=True)
...
def register_thirdparty_generics() -> None:  # noqa: PLR0915
    ...
    register("redis.asyncio.cluster.RedisCluster", (_StrType,), noop_ok=True)
    ...
    register("openpyxl.worksheet.dimensions.DimensionHolder", (_DimT,), noop_ok=True)

    # Generated from `class ArrayDescriptor(Generic[_T]):`
    # @ typeshed/stubs/openpyxl/openpyxl/styles/cell_style.pyi:15
    register("openpyxl.styles.cell_style.ArrayDescriptor", (_T,), noop_ok=True)
    ...
    register("flake8_plugin_utils.plugin.Visitor", (TConfig,), noop_ok=True)

    # Generated from `class Plugin(Generic[TConfig]):`
    # @ typeshed/stubs/flake8-plugin-utils/flake8_plugin_utils/plugin.pyi:29
    register("flake8_plugin_utils.plugin.Plugin", (TConfig,), noop_ok=True)
