    ...
    registry.update(
        {
            ...
            tuple: _PEP604VariadicGenericAlias(tuple, (), special=True),
            list: _alias(list, T),
            collections.deque: _alias(collections.deque, T),
            set: _alias(set, T),
            frozenset: _alias(frozenset, T_co),
            ...
            dict: _alias(dict, (KT, VT)),
            collections.defaultdict: _alias(collections.defaultdict, (KT, VT)),
    ...
    registry.update(
        {
            ...
            tuple: _PEP604TupleType(tuple, -1),
            list: _alias(list, 1),
            collections.deque: _alias(collections.deque, 1),
            set: _alias(set, 1),
            frozenset: _alias(frozenset, 1),
            ...
            dict: _alias(dict, 2),
            collections.defaultdict: _alias(collections.defaultdict, 2),
