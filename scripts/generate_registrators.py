...
"""Generate `__modern_types__._auto` from typeshed. Python 3.9+ required."""
...
def generate_typeshed_registrators(
    path: Path = Path("__modern_types__/_typeshed.py"),
) -> None:
    type_vars: list[TypeVarInfo] = []
...
if __name__ == "__main__":
    copy_context().run(generate_typeshed_registrators)
